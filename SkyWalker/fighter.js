...
//飞机部件
class FighterPartCover extends FighterPart{
    constructor(fighter,cfgs){
        super(fighter,cfgs);
...
//引擎风扇
class FighterPartFan extends FighterPart{
    constructor(fighter,cfgs){
        super(fighter,cfgs);
...
//阴影
class FighterPartShadow extends FighterPart {
    constructor(fighter,cfgs){
        super(fighter,cfgs);
...
//喷火战机
class SpitFire extends  Fighter{
