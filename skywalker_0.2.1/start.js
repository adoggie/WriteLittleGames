game_configs ={
                ...
                {   id:'mission1', cls: SceneMission1, cfgs:{},
                    ...
                    enemy_factory:{
                        ...
                        groups:[
                            ...
                            {
                               spawn:EnemySpawn, id:'ki46',layer:'enemy',total:200,freqs:[5,10],num:[1,1], path:{ cls:StraightPath, dx:0,dy:2.5 }, // 出机数量
                            }
                        ]
                    },
                    layers:[
    ...
    bullet_list:[
        {   id:'fire_gun',cls:Bullet,speed:3,damage:50,ims: 'ims_bullet_m1',collider:[{id:'',cls:CollideRect,x:0,y:0,w:14,h:38},],
            sound:{fire:'machine_gun',hit:'enemy_hit'}
            }, // w:0 采用图片整个宽度
        {   id:'mechine_gun',cls:Bullet,speed:4,damage:20,ims: 'ims_bullet_mg1',collider:[{id:'',cls:CollideRect,x:0,y:0,w:5,h:11},],
