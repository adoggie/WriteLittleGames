...
class TimerDelay{
  ...
  run(){
    this.timeEllapsed += getDeltaTime()/1000;
...
// 延时执行
export class TimerDelayForClassFunc{
...
export class ControllPad{
  ...
  constructor(cfgs){
    ...
    this.dx = 0;
    this.dy = 0;
    if( this.cfgs.r  > StageManager.instance.get().getSize().w /2){
      this.cfgs.r = StageManager.instance.get().getSize().w/6;
    }
